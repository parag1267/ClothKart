    ...
    async (userData, { rejectWithValue }) => {
        try {
            const res = await axios.post(
                "https://clothing-e-commerce-web-application.onrender.com/api/auth/signup",
                userData,
...
export const loginUser = createAsyncThunk(
    ...
    async (userData, { rejectWithValue }) => {
        try {
            const res = await axios.post(
                "https://clothing-e-commerce-web-application.onrender.com/api/auth/signin",
                userData,
                { withCredentials: true }
            );
            return res.data;
    ...
    async (_, { rejectWithValue }) => {
        try {
            const res = await axios.get(
                "https://clothing-e-commerce-web-application.onrender.com/api/auth/profile",
                { withCredentials: true }
            );
...
export const logoutUser = createAsyncThunk(
    ...
    async (_, { dispatch, rejectWithValue }) => {
        try {
            await axios.post(
                "https://clothing-e-commerce-web-application.onrender.com/api/auth/logout",
                {},
                { withCredentials: true }
            )
        } catch (error) {
